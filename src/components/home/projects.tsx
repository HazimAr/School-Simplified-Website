            ...
            <Stack>
              ...
              >
                <Heading size="lg" mb={{ base: 2, md: 0 }}>
                  Start Your <Link href="/projects">Project</Link> Today
                </Heading>

                <Text mt={2} mb={3} fontSize={19}>
                  Take the chance to showcase your capability, creativity, and
                  ideas while receiving community service hours and possibly
                ...
                <Box rounded={15} bg="#5E65B7" px={7} py={5}>
                  <HStack spacing={0}>
                    <VStack align="start" textAlign="left">
                      <Heading fontSize={24}>What is a Project?</Heading>
                      <Text mt={6} textAlign="left">
                        A project is a temporary initiative undertaken to
                        further School Simplified's mission of revolutionizing
                        the future through learning!
                      </Text>
                      <Text mt={6} textAlign="left">
                        Projects can include almost anything from hackathons,
                        advocacy campaings, competitive startups, and more!
                      </Text>
                      ...
                      >
                        ...
                        <NextLink
                          ...
                          _hover={{ textDecoration: "none" }}
                        >
                          <Button timmysrc="/timmy/17.png">Learn More</Button>
                        </NextLink>
                      </Stack>
                    </VStack>
