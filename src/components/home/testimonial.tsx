...
const reviews: Review[] = [
	...
	{
		review: "I just wanna thank you again because you not only helped me in Biology, but also in just general knowledge that I should probably know. I really appreciate your help, may the lake always stay with you. You were such a great tutor and I was lucky to get you!!",
		name: "Sasha",
