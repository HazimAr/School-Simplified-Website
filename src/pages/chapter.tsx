					...
					<HStack>
						<VStack alignItems="flex-start">
							...
							<Text fontSize="18px" textAlign="left">
								...
								With the chapters program, motivated students from around the world are able to gain leadership experience, 
								conduct service projects, and help others progress in their academics. Chapters can offer service, tutoring, 
								essay revision, and college resources. Each chapter is free to focus on one or more areas of interest.
							</Text>
						</VStack>
						<Image src="/timmy/timmy_chapter.png"  display={{ base: "none", md: "block" }} alt="Timmy with globe" />
					</HStack>
				</ContainerInside>
			</Container>
		</>
