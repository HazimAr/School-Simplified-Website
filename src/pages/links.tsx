import { Icon, Text, Image, Center, VStack, HStack, Link, Button, } from "@chakra-ui/react";
import { SiTiktok, SiInstagram, SiTwitter, SiLinkedin} from 'react-icons/si';
		...
		<>
            <Center>
                <VStack spacing={3}>
                    ...
                    <VStack spacing={4}>
                        <Button leftIcon={<FaDiscord size="25px" />}  width="500px" height="60px" mt="25px" rounded="30px" boxShadow="md" >
                            Join School Help Discord 
                        </Button>

                        <Button leftIcon={<FaGamepad size="30px" />}  width="500px" height="60px" rounded="30px" boxShadow="md" >
                            Join Minecraft Discord 
                        </Button>

                        <Button leftIcon={<HiUserGroup size="30px" />}  width="500px" height="60px" rounded="30px" boxShadow="md" >
                            Join Our Staff 
                        </Button>

                        <Button leftIcon={<HiOutlineMail size="30px" />}  width="500px" height="60px" rounded="30px" boxShadow="md" >
                            Contact Us 
                        </Button>
