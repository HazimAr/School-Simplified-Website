		...
		<Container bg="brand.purple.dark">
			<ContainerInside>
				<Box maxW="400px">
					...
					<Text>
						We simplify complicated material by offering notes and
						free help with classes! Our resources cover both AP and
						non-AP courses, allowing you to explore the intricacies
